...
export const PharmacyWorkspace: React.FC<PharmacyWorkspaceProps> = ({
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300 pb-12">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#064E3B] via-[#0F766E] to-[#134E4A] p-6 sm:p-8 text-white shadow-xl border border-emerald-600/30">
        <div className="absolute top-0 right-0 -mt-8 -mr-8 w-64 h-64 rounded-full bg-emerald-400/10 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-1/3 -mb-12 w-48 h-48 rounded-full bg-teal-300/10 blur-2xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-emerald-100/80 text-sm max-w-2xl font-medium">
          ...
          <div className="flex items-center gap-3 self-start md:self-auto">
            <button
              ...
              disabled={loading}
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/10 hover:bg-white/20 active:scale-95 border border-white/20 text-white text-xs font-bold transition-all backdrop-blur-sm"
            ...
            <div className="hidden sm:flex flex-col text-right">
              <span className="text-[11px] font-semibold uppercase tracking-wider text-emerald-300">Logged Pharmacist</span>
        ...
        <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4 relative z-10">
          <div className="rounded-2xl bg-white/10 backdrop-blur-md p-4 border border-white/15 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-emerald-200">Pending Rx Queue</p>
              <p className="text-2xl font-black text-white mt-1">{pendingRxCount}</p>
              <span className="text-[11px] text-emerald-300 font-medium">Doctor Orders Awaiting</span>
            </div>
            <div className="w-11 h-11 rounded-xl bg-emerald-500/30 flex items-center justify-center text-emerald-200">
          ...
          <div className="rounded-2xl bg-white/10 backdrop-blur-md p-4 border border-white/15 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-emerald-200">Low Stock Triggers</p>
              <p className="text-2xl font-black text-amber-300 mt-1">{lowStockCount}</p>
              <span className="text-[11px] text-amber-200/80 font-medium">Needs Reordering</span>
            </div>
            <div className="w-11 h-11 rounded-xl bg-amber-500/30 flex items-center justify-center text-amber-200">
          ...
          <div className="rounded-2xl bg-white/10 backdrop-blur-md p-4 border border-white/15 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-emerald-200">Dispensed Today</p>
              <p className="text-2xl font-black text-white mt-1">{fulfilledTodayCount}</p>
              <span className="text-[11px] text-emerald-300 font-medium">Completed Prescriptions</span>
            </div>
            <div className="w-11 h-11 rounded-xl bg-teal-500/30 flex items-center justify-center text-teal-200">
          ...
          <div className="rounded-2xl bg-white/10 backdrop-blur-md p-4 border border-white/15 flex items-center justify-between">
            <div>
              <p className="text-xs font-semibold text-emerald-200">Inventory Valuation</p>
              <p className="text-2xl font-black text-white mt-1">${estimatedVaultValue.toLocaleString()}</p>
              <span className="text-[11px] text-emerald-300 font-medium">{inventory.length} Drug SKUs</span>
            </div>
            <div className="w-11 h-11 rounded-xl bg-emerald-400/30 flex items-center justify-center text-emerald-100">
